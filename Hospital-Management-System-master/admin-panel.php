                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel.php?ID=" 
                              ...
                              title="Pay Bill" tooltip-placement="top" tooltip="Remove"><button class="btn btn-success">Pay</button>
                                                                ...
                                                                <!--    <form method="post">
                                                                          <button type="submit">Generate Bill (5 Times)</button>
                                                                    </form>
                                                                      function generate_bill($patient_id) {
                                                                        for ($i = 0; $i < 5; $i++) {
                                                                          // ... existing code to retrieve appointment details ...
                                                                          
                                                                          // Generate and display bill content here
                                                                          echo "<h2>Bill #" . ($i + 1) . "</h2>"; // Add numbering for each bill
                                                                          // ... existing code to generate bill details ...
                                                                        }
                                                                        }?> -->
